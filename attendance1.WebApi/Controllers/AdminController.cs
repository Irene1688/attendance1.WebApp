...
namespace attendance1.WebApi.Controllers
{
    ...
    public class AdminController : ControllerBase
    {
        ...
        public async Task<ActionResult<PaginatedResult<GetProgrammeResponseDto>>> GetAllProgramme([FromBody] PaginatedRequestDto requestDto)
        {
        ...
        public async Task<ActionResult<PaginatedResult<GetCourseResponseDto>>> GetAllCourse([FromBody] PaginatedRequestDto requestDto)
        {
