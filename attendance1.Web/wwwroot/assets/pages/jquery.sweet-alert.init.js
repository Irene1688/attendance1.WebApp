...
!function ($) {
    ...
    SweetAlert.prototype.init = function () {
        ...
        $('#sa-success').click(function () {
            swal("Success!", "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed lorem erat, tincidunt vitae ipsum et, pellentesque maximus enim. Mauris eleifend ex semper, lobortis purus sed, pharetra felis", "success")
        });

        //Success Message-custom
        $('#sa-success-add-class').ready(function () {
            swal("Success!", "A new class is added.", "success")
        });
